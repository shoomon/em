export const slides = [
  ...
  {
    id: 1,
    video_url: "video/onboarding/read.mp4",
    title: "당신의 위치에서",
    subtitle: "지도에 남겨진 마음을 확인하고, 공감해보세요.",
  },
  {
    id: 2,
    video_url: "video/onboarding/write.mp4",
    title: "당신의 감정을",
    subtitle: "위치에 남겨보세요, 음악도 가능해요.",
  },
  {
    id: 3,
    video_url: "video/onboarding/calendar.mp4",
    title: "달력에 감정을",
    subtitle: "색으로 표현해요. 지난 감정을 둘러보세요.",
  },
  {
    id: 4,
    video_url: "video/onboarding/music-recommend.mp4",
    title: "감정을 모아",
